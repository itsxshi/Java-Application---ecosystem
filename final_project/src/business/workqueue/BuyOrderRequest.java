 ...
 * @author yi
 */
public class BuyOrderRequest extends WorkRequest {
    
    private FurnitureDir orderedFurnitures;
    
    public BuyOrderRequest(User requestUser, User resolveUser, Date requestDate, Date resolveDate, WorkRequest.status status,FurnitureDir orderedFurnitures) {
